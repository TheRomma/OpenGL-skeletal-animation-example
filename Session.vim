...
silent only
silent tabonly
cd ~/dev/school/computer_graphics
...
wincmd w
argglobal
if bufexists("scene.cpp") | buffer scene.cpp | else | edit scene.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("renderer.cpp") | buffer renderer.cpp | else | edit renderer.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((37 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
wincmd w
argglobal
if bufexists("3Dmath.cpp") | buffer 3Dmath.cpp | else | edit 3Dmath.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 199 - ((45 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
199
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 52 + 101) / 203)
exe 'vert 2resize ' . ((&columns * 150 + 101) / 203)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((18 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 49 + 101) / 203)
exe 'vert 2resize ' . ((&columns * 153 + 101) / 203)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((34 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
wincmd w
argglobal
if bufexists("animation.cpp") | buffer animation.cpp | else | edit animation.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
